                       ...
                       <!-- <hr class="mb-4">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="invalid-feedback"> Nom complet tel qu'affiché sur la carte  </div>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="payment-icon">
                                    <ul>
                                        <li><img class="img-fluid" src="fontend/images/payment-icon/1.png" alt=""></li>
                                        <li><img class="img-fluid" src="fontend/images/payment-icon/2.png" alt=""></li>
                                        <li><img class="img-fluid" src="fontend/images/payment-icon/3.png" alt=""></li>
                                        <li><img class="img-fluid" src="fontend/images/payment-icon/5.png" alt=""></li>
                                        <li><img class="img-fluid" src="fontend/images/payment-icon/7.png" alt=""></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-12 mb-12">
